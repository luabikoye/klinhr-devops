            ...
            <div class="row">
                ...
                <div class="col-md-11">
                    <div class="profile_bodyBox">
                        ...
                        <form method="post" action="proc_social_media">
                            ...
                            <?php if ($_GET['succ'] == 'yes') { ?>
                                ...
                                <p>
                                <div class="alert alert-success">Your job preference has been saved succesfully. </div>
                                </p>
                            ...
                            <div class="row personal-info-inp">
                                <div class="col-md-6">
                                    <p>Facebook URL</p>
                                    <input type="text" placeholder="Enter Facebook URL" class="profile-input" name="facebook" value="<?php echo $profile_row['facebook']; ?>" />
                                </div>
                                <div class="col-md-6">
                                    <p>Twitter URL</p>
                                    <input type="text" placeholder="Enter Twitter URL" class="profile-input" name="twitter" value="<?php echo $profile_row['twitter']; ?>" />
                                </div>
                                <div class="col-md-6">
                                    <input type="text" placeholder="Linkedin URL" class="profile-input" name="linkedin" value="<?php echo $profile_row['linkedin']; ?>" />
                                </div>
                                <div class="col-md-6">
                                    <input type="text" placeholder="Instagram URL" class="profile-input" name="instagram" value="<?php echo $profile_row['instagram']; ?>" />
                                </div>
