...
$profile_query = "select * from favourite where candidate_id = '" . $_SESSION['candidate_id'] . "' ";
                    ...
                    <div class="dashboard_body">
                        ...
                        <div class="container">
                            ...
                            <div class="appliedJobsro">
                                <div class="appliedJobsro1"><?= $profile_num ?> Saved Job(s)</div>
                            </div>
                            ...
                            <strong>Application Withdrawn from saved jobs</strong>
                             </div>';
                            }
                            ?>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="border-top: none; border-bottom: none;">Date</th>
                                    ...
                                    <tbody>
                                        ...
                                        $total_query = "SELECT COUNT(*) FROM favourite WHERE candidate_id = '" . $_SESSION['candidate_id'] . "'";
                                        ...
                                        $notification_query = "SELECT * FROM favourite WHERE candidate_id = '" . $_SESSION['candidate_id'] . "' LIMIT $offset, $records_per_page";
                                        $notification_result = mysqli_query($db, $notification_query);
                                        $num = mysqli_num_rows($notification_result);
                                        ...
                                        ?>
                                            <tr>
                                                <th scope="row" style="border-top: none;"><?= get_val('clients', 'id', get_val('job_post', 'id', $notification_row['jobs_id'], 'client_id'), 'client_name') ?></th>
                                                <td style="border-top: none;">
                                                    <div id="apjbh"><?= ucwords(get_val('job_post', 'id', $notification_row['jobs_id'], 'job_title')) ?> <br> <button><?= get_val('job_post', 'id', $notification_row['jobs_id'], 'job_type') ?></button> <i class="fa-solid fa-location-dot"></i> <span><?= get_val('job_post', 'id', $notification_row['jobs_id'], 'state') ?>.</span></div>
                                                </td>
                                                <td style="border-top: none;"><?= long_date(get_val('job_post', 'id', $notification_row['jobs_id'], 'date_posted')) ?></td>
                                                <td style="border-top: none;">
                                                    <a href="job-description?valid=<?= base64_encode($notification_row['jobs_id']); ?>" style="color: #006bff;"><i title="View Job Description" class="fa-regular fa-eye"></i></a>&nbsp;&nbsp;&nbsp;
                                                    <a href="remove-fav?id=<?= base64_encode($notification_row['id'])?>" style="color: #E52936;"><i class="fa-solid fa-trash-can" title="Remove from saved Jobs"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
