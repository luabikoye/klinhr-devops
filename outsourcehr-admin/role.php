...
if ($_SESSION['account_token']) {
    if ($_SESSION['privilege_user'] == 'administrator') {
        $query = "SELECT * FROM role WHERE account_token = '". $_SESSION['account_token']."' order by id desc";
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
            ...
            <div class="page-header">
                <div class="row align-items-end">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        Role List <span class="badge bg-soft-dark text-dark ms-1"><?php echo number_format($num) ?></span>
                    </div>
                    <!-- End Col -->
                                ...
                                <tr>
                                    ...
                                    ?>
                                        <td>
                                            ...
                                            <a data-toggle="tooltip" data-placement="top" data-original-title="Delete" href="delete-record?id=<?php echo $row['id']; ?>&tab=role&return=role" onclick="return confirm('Are you sure you want to delete this role?');" class="btn btn-sm btn-outline-secondary"><i class="bi-trash" style="margin-left:0px;"></i></a>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <!-- Step Form -->
                                                            <form class="js-step-form" action="edit_role" method="POST" enctype="multipart/form-data" data-hs-step-form-options='{
                                                                        ...
                                                                        <div class="mb-4">
                                                                            ...
                                                                            <div class="row align-items-center">
                                                                                <div class="col-12 col-md-12 mb-3">
                                                                                    <label for="clientNewProjectLabel" class="form-label">Edit Role(<?= $row['role'] ?>)</label>
                                                                                    <div class="input-group input-group-merge">
                                                                                        <input type="text" class="form-control" id="clientNewProjectLabel" value="<?php echo $row['role']; ?>" name="role">
                                                                                        <input class="form-control" id="clientNewProjectLabel" type="hidden" value="<?php echo $row['id']; ?>" name="id">
                                                                                        <input class="form-control" id="clientNewProjectLabel" type="hidden" value="<?php echo $row['role']; ?>" name="old_role">
                                                                                    </div>
                                                                                </div>
                                                                                <!-- End Col -->
    ...
    <div class="modal fade" id="newProjectModal" tabindex="-1" aria-labelledby="newProjectModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="newProjectModalLabel">Manage Job Roles</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                ...
                <div class="modal-body">
                    <!-- Step Form -->
                    <form class="js-step-form" action="add_role" method="POST" enctype="multipart/form-data" data-hs-step-form-options='{
                  "progressSelector": "#createProjectStepFormProgress",
                  "stepsSelector": "#createProjectStepFormContent",
                  "endSelector": "#createProjectFinishBtn",
                  "isValidate": false
                        ...
                        <div id="createProjectStepFormContent">
                            <div id="createProjectStepDetails" class="active">
                                <!-- Form -->
                                <div class="mb-4">
                                    <label for="clientNewProjectLabel" class="form-label">New Role</label>

                                    <div class="row align-items-center">
                                        <div class="col-12 col-md-12 mb-3">
                                            <div class="input-group input-group-merge">
                                                <input class="form-control" id="clientNewProjectLabel" name="role" placeholder="" aria-label="">
                                            </div>
                                        </div>
                                        <!-- End Col -->
                                    </div>
                              ...
                              "targetSelector": "#createProjectStepTerms"
                                            ...
                                            Add Role <i class="bi-chevron-right"></i>
                                        </button>
                                    </div>
                                </div>
                                <!-- End Footer -->
