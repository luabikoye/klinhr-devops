...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
    ...
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
            <!-- Step Form -->
            <form class="js-step-form py-md-5" action="proc_change_password" method="post" enctype="multipart/form-data" data-hs-step-form-options='{
                        ...
                        <div id="addUserStepFormContent">
                            ...
                            <div id="addUserStepProfile" class="card card-lg active">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Form -->
                                    <div class="row mb-4">
                                        <label for="firstNameLabel" class="col-sm-3 col-form-label form-label">Current Password</label>

                                        <div class="col-sm-9">
                                            <div class="input-group input-group-sm-vertical">
                                                <input type="password" class="form-control" name="old_password" id="firstNameLabel" placeholder="" aria-label="">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End Form -->
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group input-group-sm-vertical">
                                                <input type="password" class="form-control" name="new_password" id="firstNameLabel" placeholder="" aria-label="">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End Form -->
                                    ...
                                    <!-- Form -->
                                    <div class="row mb-4">
                                        <label for="locationLabel" class="col-sm-3 col-form-label form-label">Confirm Password</label>

                                        <div class="col-sm-9">
                                            <!-- Select -->
                                            <div class="input-group input-group-sm-vertical">
                                                <input type="password" class="form-control" name="confirm_password" id="firstNameLabel" placeholder="" aria-label="">
                                            </div>
                                        </div>
                                        <!-- End Form -->
                                    </div>
