...
<head>
    ...
    <!-- Title -->
    <title>Upload Evidence | KlinHR</title>
            ...
            <div class="page-header">
                <div class="row align-items-end">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        <h1 class="page-header-title">Upload Evidence for
                            <?php echo $row['firstname'].' '.$row['surname']; ?></h1>
                    </div>
                </div>
                <!-- End Row -->
            </div>
                ...
                <div class="col-lg-9">
                    <div class="d-grid gap-3 gap-lg-5">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <!-- Form -->
                                <form action="ProcessCandidate?candidate_id=<?php echo base64_encode($candidate_id); ?>"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a data-toggle="tooltip" data-placement="top"
                                                    ...
                                                    href="delete-evidence?id=<?php echo base64_encode($credentials_row['id']); ?>&candidate_id=<?= base64_encode($candidate_id) ?>"
