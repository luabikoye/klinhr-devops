...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
    ...
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
            <!-- Step Form -->
            <form class="js-step-form py-md-5" method="post" action="proc_add_client" enctype="multipart/form-data" data-hs-step-form-options='{
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="tom-select-custom mb-4">
                                                <input type="text" class="form-control" name="client_name" id="firstNameLabel" placeholder="" aria-label="Clarice" value="<?= $client_name ?>">
                                            </div>
                                        </div>
                                        <!-- End Form -->
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-9">
                                                <!-- Select -->
                                                <div class="tom-select-custom mb-4">
                                                    <input type="text" class="form-control" name="client_code" id="firstNameLabel" placeholder="" aria-label="Clarice" value="<?= $client_code ?>">
                                                </div>
                                                <!-- End Select -->
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-9">
                                                <!-- Select -->
                                                <div class="tom-select-custom mb-4">
                                                    <input type="text" class="form-control" name="contact_person" id="firstNameLabel" placeholder="" aria-label="Clarice" value="<?= $contact_person ?>">
                                                </div>
                                                <!-- End Select -->
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group input-group-sm-vertical">
                                                    <input type="email" class="form-control" name="email" id="firstNameLabel" placeholder="" aria-label="Clarice" value="<?= $email ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End Form -->
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group input-group-sm-vertical">
                                                    <input type="text" class="form-control" name="phone" id="firstNameLabel" placeholder="" aria-label="Clarice" value="<?= $phone ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End Form -->
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group input-group-sm-vertical">
                                                    <input type="file" class="form-control" name="logo" id="firstNameLabel" placeholder="" aria-label="Clarice" value="<?= $ogo ?>">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-9">
                                                <label class="form-control" for="userAccountTypeRadio1">
                                                    <span class="form-check">
                                                        <input type="checkbox" class="form-check-input" value="yes" name="online" id="userAccountTypeRadio1">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-4">
                                                <label class="form-control" for="userAccountTypeRadio2">
                                                    <span class="form-check">
                                                        <input type="radio" class="form-check-input" value="enabled" required name="clockin" id="userAccountTypeRadio2">
                                            ...
                                            <div class="col-sm-4">
                                                <label class="form-control" for="userAccountTypeRadio3">
                                                    <span class="form-check">
                                                        <input type="radio" class="form-check-input" value="disabled" required name="clockin" id="userAccountTypeRadio3">
                                        ...
                                        <div id="clockin">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-3">
                                                    <label class="form-control" for="userAccountTypeRadio4">
                                                        <span class="form-check">
                                                            <input type="radio" class="form-check-input" value="onsite" name="geofence" id="userAccountTypeRadio4">
                                                ...
                                                <div class="col-sm-3">
                                                    <label class="form-control" for="userAccountTypeRadio5">
                                                        <span class="form-check">
                                                            <input type="radio" class="form-check-input" value="flexible" name="geofence" id="userAccountTypeRadio5">
                                                ...
                                                <div class="col-sm-3">
                                                    <label class="form-control" for="userAccountTypeRadio6">
                                                        <span class="form-check">
                                                            <input type="radio" class="form-check-input" value="both" name="geofence" id="userAccountTypeRadio6">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group input-group-sm-vertical">
                                                        <input type="text" class="form-control" name="location" id="firstNameLabel" placeholder="" aria-label="Clarice" value="<?= $phone ?>">
                                                    </div>
                                                </div>
                                            </div>
