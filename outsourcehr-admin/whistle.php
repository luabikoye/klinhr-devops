...
if ($_SESSION['privilege_user'] == 'administrator') {
    $query = "SELECT * FROM emp_whistle order by  id desc";
} elseif ($_SESSION['privilege_user'] == 'ALL') {
    $query = "SELECT * FROM emp_whistle order by id desc";
} else {
    $query = "SELECT * FROM emp_whistle where access_type like '%" . get_priviledge($_SESSION['privilege_user']) . "%' order by id desc";
}
            ...
            <a class="btn btn-primary" href="javascript:;" data-bs-toggle="modal" data-bs-target="#newProjectModal">
              <i class="bi-plus me-1"></i> New project
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        Whistle <span class="badge bg-soft-dark text-dark ms-1"><?php echo number_format($num) ?></span>
                    </li>
                    <!-- <li class="nav-item">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <?php echo get_names($row['staff_id']); ?>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                ...
                                <td>
                                    <?php echo substr($row['whistle'], 0, 10); ?>...<a href="javascript:;"
                                                            ...
                                                            <div id="createProjectStepDetails" class="active">
                                                                ...
                                                                <div class="mb-4">
                                                                    ...
                                                                    <div class="row align-items-center">
                                                                        <div class="col-12 col-md-6 mb-3">
                                                                            ...
                                                                            <div class="input-group input-group-merge">
                                                                                <input class="form-control"
                                                                                    ...
                                                                                    value="<?php echo get_names($row['staff_id']); ?>"
                                                                        ...
                                                                        <div class="col-12 col-md-6 mb-3">
                                                                            <label for="clientNewProjectLabel"
                                                                                class="form-label">Reporting</label>
                                                                            <div class="input-group input-group-merge">
                                                                                <input class="form-control"
                                                                                    id="clientNewProjectLabel"
                                                                                    value="<?php echo get_names($row['manager']); ?>(<?php echo stripslashes($row['reporting']); ?>)"
                                                                                    readonly
                                                                                    aria-label="Add creater name">
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="mb-4">
                                                                    ...
                                                                    <div class="row align-items-center">
                                                                        <div class="col-12 col-md-6 mb-3">
                                                                            <label for="clientNewProjectLabel"
                                                                                class="form-label">Whistle</label>
                                                                            <div class="input-group input-group-merge">
                                                                                <input class="form-control"
                                                                                    id="clientNewProjectLabel" readonly
                                                                                    value="<?php echo stripslashes($row['whistle']); ?>"
                                                                                    aria-label="Add creater name">
                                                                            </div>
                                                                        </div>
                                                                        <!-- End Col -->
                                                                        ...
                                                                        <div class="col-12 col-md-6 mb-3">
                                                                            ...
                                                                            <div class="input-group input-group-merge">
                                                                                <input class="form-control"
                                                                                    id="clientNewProjectLabel"
                                                                                    value="<?php echo stripslashes($row['how_long']); ?>"
                                                                                    readonly
                                                                                    aria-label="Add creater name">
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="row align-items-center">
                                                                        <div class="col-12 col-md-6 mb-3">
                                                                            ...
                                                                            <div class="input-group input-group-merge">
                                                                                <input class="form-control"
                                                                                    id="clientNewProjectLabel" readonly
                                                                                    value="<?php echo stripslashes($row['additional_info']); ?>"
                                                                                    aria-label="Add creater name">
                                                                            </div>
                                                                        </div>
                                                                        <!-- End Col -->
