...
<head>
    ...
    <!-- Title -->
    <title>Edit Template | KlinHR</title>
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
    ...
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
            <!-- Step Form -->
            <form class="js-step-form py-md-5" action="proc_edit_template" method="post" enctype="multipart/form-data" data-hs-step-form-options='{
                ...
                <div class="row justify-content-lg-center">
                    ...
                    "targetSelector": "#addUserStepProfile"
                                    ...
                                    <div class="step-content">
                                        <h3 class="step-title">Edit Template</h3>
                                    </div>
                                </a>
                            </li>
                        </ul>
                        ...
                        <div id="addUserStepFormContent">
                            ...
                            <div id="addUserStepProfile" class="card card-lg active">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Form -->
                                    <div class="row mb-4">
                                        <label for="locationLabel" class="col-sm-3 col-form-label form-label">Template Name</label>

                                        <div class="col-sm-9">
                                            <!-- Select -->
                                            <div class="tom-select-custom mb-4">
                                                <input type="text" class="form-control" name="template_name" class="form-control" id="inputName" required value="<?php echo $row['template_name']; ?>">
                                        ...
                                        <!-- Form -->
                                        <div class="row mb-4">
                                            <label for="locationLabel" class="col-sm-3 col-form-label form-label">Template Subject</label>

                                            <div class="col-sm-9">
                                                <!-- Select -->
                                                <div class="tom-select-custom mb-4">
                                                    <input type="text" class="form-control" name="template_subject" placeholder="" required value="<?php echo $row['template_subject']; ?>">
                                                </div>
                                                <!-- End Select -->
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="quill-custom">
                                                <textarea name="sms_content" id="sms_content" required>
                                                    <?php echo $row['sms_content']; ?>
                                                </textarea>
                                                <script>
