        ...
        <div class="content container-fluid">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <!-- Form -->
                                            <div class="mb-4">
                                                <label for="firstNameLabel" class="form-label">Client</label>
                                                <input type="text" class="form-control" name="client" id="firstNameLabel" placeholder="" aria-label="Clarice">
                                            </div>
                                            <!-- End Form -->
                                        </div>
                                        <!-- End Col -->
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select class="form-control" name="client_id" id="lastNameLabel">
                                                    <?php
                                                    if (isset($_POST['client'])) {
                                                    ?>
                                                        <option value="<?php echo $_POST['client_id']; ?>"><?php echo $_POST['client_id']; ?></option>
                                                    <?php } ?>
            ...
            <div class="page-header">
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        Payroll Clients <span class="badge bg-soft-dark text-dark ms-1"><?php echo number_format($num_d) ?></span>
                    </li>
                </ul>
                <!-- End Nav -->
            </div>
