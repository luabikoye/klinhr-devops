...
$query = mysqli_query($db, "select * from payslip where current_year = '$year' && current_month = '$month'");
$num = mysqli_num_rows($query);

$sql = mysqli_query($db, "select SUM(take_home) as total_net from payslip where current_year = '$year' && current_month = '$month'");
$row_net = mysqli_fetch_assoc($sql);
$net_pay = $row_net['total_net'];
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        <h1 class="page-header-title">Salary Advice</h1>
                    </div>
                    <!-- End Col -->

                    <div class="col-md-auto">
                        <?php if (date('F-Y') == $row['pay_month']) { ?>
                            <a class="btn btn-primary" href="disburse-pay">
                                Approve Payment
                            <?php } ?>
                            </a>
                    </div>
            ...
            <div class="card">
                ...
                <div class="table-responsive datatable-custom">
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <?php if ($_GET['success'] == '1') echo '<div class="alert alert-success"><strong>Success: </strong>Staff Added.</div>'; ?>
                        <?php if ($_GET['sent'] == '1') echo '<div class="alert alert-success"><strong>Success: </strong>Payslip Sent.</div>'; ?>
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="table-column-ps-0">Account Number</th>
                                <th class="table-column-ps-0">Amount</th>
                                <th class="table-column-ps-0">Salary For</th>
                            </tr>
                        </thead>
                ...
                <div class="card-footer">
                    <div class="row justify-content-center justify-content-sm-between align-items-sm-center">
                        ...
                        <div class="col-sm-4">
                            <div class="d-flex justify-content-center justify-content-sm-end">
                                <!-- Pagination -->
                                <p><b>TOTAL:</b> &nbsp;&nbsp;&#8358;<?= number_format($net_pay, 2) ?></p>
                            </div>
                        </div>
                        <!-- End Col -->
    ...
    ?>
        <script type="text/javascript">
            $(function() {
                ...
                toastr['error']('Payslip sent successfully', );
            });
        </script>
    <?php }
    if ($_GET['sent'] == '1') {
