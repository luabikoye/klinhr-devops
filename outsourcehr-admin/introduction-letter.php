...
if ($_GET['unique']) {
    $email = base64_decode($_GET['unique']);

    activity_log($_SESSION['Klin_admin_user'], 'Responded to  ' . get_val('emp_staff_details', 'email_address', $email, 'firstname') . ' ' . get_val('emp_staff_details', 'email_address', $email, 'surname') . ' Introduction Letter Request ');
}
if ($_SESSION['privilege_user'] == 'administrator') {
    $query = "SELECT * FROM emp_reference order by status asc, id desc";
} elseif ($_SESSION['privilege_user'] == 'ALL') {
    $query = "SELECT * FROM emp_reference  order by id desc";
} else {
    $query = "SELECT * FROM emp_reference where access_type like '%" . get_priviledge($_SESSION['privilege_user']) . "%' order by status asc, id desc";
}
...
<head>
    ...
    <!-- Title -->
    <title>Introduction | KlinHR</title>
        ...
        <div class="content container-fluid">
            ...
            <div class="card">
                ...
                <div class="table-responsive datatable-custom">
                    ...
                    <?php if ($_GET['msg'] == 'success') echo '<div class="alert alert-success"> Issue successfully treated </div>'; ?>
                    <?php if ($_GET['msg'] == 'revert') echo '<div class="alert alert-success"> Issue successfully revert </div>'; ?>
                    <?php if ($_GET['msg'] == 'sent') echo '<div class="alert alert-success"> Email sent successfully </div>'; ?>
                    <table id="datatable"
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo substr($row['purpose'], 0, 20); ?>...<a href="javascript:;"
                                                        ...
                                                        <div id="createProjectStepFormContent">
                                                            <div id="createProjectStepDetails" class="active">
                                                                    ...
                                                                    <div class="col-12 col-md-6 mb-3">
                                                                        ...
                                                                        <div class="input-group input-group-merge">
                                                                            <input class="form-control"
                                                                                ...
                                                                                value="<?php echo stripslashes($row['location']); ?>"
                                                                                aria-label="Add creater name">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12 col-md-6 mb-3">
                                                                        <label for="clientNewProjectLabel"
                                                                            class="form-label">Address To</label>
                                                                        <div class="input-group input-group-merge">
                                                                            <input class="form-control"
                                                                                id="clientNewProjectLabel" readonly
                                                                                value="<?php echo stripslashes($row['address_to']); ?>"
                                                                                aria-label="Add creater name">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mb-4">
                                                                    <label for="clientNewProjectLabel"
                                                                        class="form-label"
                                                                        style="font-weight:bold">Purpose</label>

                                                                    <div class="row align-items-center">
                                                                        <div class="col-12 col-md-12 mb-3 pt-3">
                                                                            <textarea name="" id="" cols="30" rows="10"
                                                                                class="form-control"
                                                                                style="border: none;"><?= $row['purpose']; ?></textarea>
                                                                ...
                                                                <div class="d-flex align-items-center mt-5">
                                                                    <div class="ms-auto">
                                                                        <a class="btn btn-primary"
                                                                            href="reply_staff?email=<?php echo base64_encode($row['email']); ?>&sub=RE:Reference Letter&return_url='<?php echo base64_encode('introduction-letter'); ?>">
                                                                            Reply
                                                                        </a>
                                                                    </div>
                                                                </div>
                                ...
                                <td>
                                    ...
                                    <a onClick="return confirm('Are you sure you have treated this issue?');"
                                        href="status_btn?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('emp_reference'); ?>&e=<?php echo base64_encode($row['email']); ?>&n=<?php echo base64_encode($row['name']); ?>&sub=<?php echo base64_encode($row['ref_type']); ?>&return_url=<?php echo base64_encode('introduction-letter?msg=success'); ?>&status=<?php echo base64_encode('done'); ?>"><input
                                            type="button" class="btn btn-sm btn-outline-secondary"
                                            value="Mark as Done" /></a>

                                    <?php } else { ?>
                                    <a onClick="return confirm('Are you sure you want to revert this complaint?');"
                                        href="status_btn?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('emp_reference'); ?>&return_url=<?php echo base64_encode('introduction-letter?msg=revert'); ?>&status=<?php echo base64_encode('pending'); ?>"><input
                                            type="button" class="btn btn-sm btn-outline-secondary"
                                            value="Mark as Undone" /></a>
                                    <?php } ?>
