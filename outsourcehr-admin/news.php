...
if ($_SESSION['privilege_user'] == 'administrator') {
    $query = "SELECT * FROM emp_news order by  id desc";
} elseif ($_SESSION['privilege_user'] == 'ALL') {
    $query = "SELECT * FROM emp_news  order by id desc";
} else {
    $query = "SELECT * FROM emp_news where access_type like '%" . get_priviledge($_SESSION['privilege_user']) . "%' order by id desc";
}
...
<head>
    ...
    <!-- Title -->
    <title>News/Events | KlinHR</title>
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-end">
                    ...
                    <div class="col-sm-auto">
                        <a class="btn btn-primary" href="add-news">
                            <i class="bi-plus me-1"></i> Add Events
                        </a>
                    </div>
                    <!-- End Col -->
                </div>
            ...
            <div class="card">
                ...
                <div class="table-responsive datatable-custom">
                    ...
                    <?php if ($_GET['del'] == 'success') echo '<div class="alert alert-success">Event successfully deleted</div>'; ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="table-column-ps-0">
                                        <?php echo strip_tags(substr($row['summary'], 0, 50)); ?>...<a href="javascript:;" data-bs-toggle="modal" data-bs-target="#newProjectModal<?php echo ($row['id']); ?>">more</a>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="newProjectModalLabel"><?php echo ($row['title']); ?>(<?= $row['date']; ?>)</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form class="js-step-form" data-hs-step-form-options='{
                                                            ...
                                                            <!-- Step -->
                                                            <ul id="createProjectStepFormProgress" class="js-step-progress step step-sm step-icon-sm step-inline step-item-between mb-3 mb-sm-7" style="display: none;">
                                                                <li class="step-item">
                                                            ...
                                                            <div id="createProjectStepFormContent">
                                                                <div id="createProjectStepDetails" class="active">
                                                                    <!-- Form -->
                                                                    <div class="mb-4">
                                                                        <label for="clientNewProjectLabel" class="form-label">Summary</label>

                                                                        <div class="row ">
                                                                            <div class="col-md-4" style="width: 100%; border:2px solid;height:100px">
                                                                                <div><?= $row['summary']; ?></div>
                                                                            </div>
                                                                            <!-- End Col -->
                                                                        </div>
                                                                ...
                                                                <div id="createProjectStepTerms" style="display: none;">
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            <!-- Form -->
                                                                            <div class="mb-4">
                                                                                <label for="paymentTermsNewProjectLabel" class="form-label">Email</label>

                                                                                <!-- Select -->
                                                                                <div class="tom-select-custom">
                                                                                    <input type="email" readonly class="form-control" id="clientNewProjectLabel" value="<?php echo $row['email'] ?>" aria-label="Add creater name" name="email">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <label for="expectedValueNewProjectLabel" class="form-label">Subject</label>

                                                                            <!-- Form -->
                                                                            <div class="mb-4">
                                                                                <div class="input-group input-group-merge">
                                                                                    <input type="text" class="form-control" name="subject" id="expectedValueNewProjectLabel" value="RE:Reference Letter" aria-label="Enter value here">
                                                                                </div>
                                                                            </div>
                                                                            <!-- End Form -->
                                                                        </div>
                                                                    ...
                                                                    <!-- Footer -->
                                                                    <div class="d-flex align-items-center mt-5">
                                                                        <button type="button" style="display: none;" class="btn btn-ghost-secondary me-2" data-hs-step-form-prev-options='{
                                                                "targetSelector": "#createProjectStepDetails"
                                                                }'>
                                                                        ...
                                                                        "targetSelector": "#createProjectStepMembers"
                                                                                ...
                                                                                Send Message <i class="bi-chevron-right"></i>
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                                    <!-- End Footer -->
                                    ...
                                    ?>
                                        <td class="table-column-ps-0">
                                            <a data-toggle="tooltip" data-placement="top" data-original-title="Edit" href="edit-news?id=<?php echo base64_encode($row['id']); ?>" class="btn btn-sm btn-outline-secondary"><i class=" bi-pencil" style="margin-left:0px;"></i></a>


                                            <a data-toggle="tooltip" data-placement="top" data-original-title="Delete" href="delete-record?id=<?php echo $row['id']; ?>&tab=emp_news&return=news " onclick="return confirm('Are you sure you want to delete this news?');" class="btn btn-sm btn-outline-secondary"><i class="bi-trash" style="margin-left:0px;"></i></a>
                                        </td>
                                    <?php } ?>
                                </tr>
                            <?php } ?>
