                            ...
                            <div class="nav-item">
                                ...
                                <div id="navbarVerticalMenuPagesUsersMenu" class="nav-collapse collapse "
                                    ...
                                    <a class="nav-link " href="./job-posted?valid=<?php echo date('Y-m-d'); ?>">
                                        ...
                                        Job Posted<span class="badge bg-info rounded-pill ms-1"><?php $count = mysqli_num_rows(mysqli_query($db, "select * from job_post where deadline >= '" . date('Y-m-d') . "'order by id desc"));
                                    ...
                                    <a class="nav-link " href="./job-posted?expired=<?php echo date('Y-m-d'); ?>">
                                        ...
                                        Job Expired <span class="badge bg-info rounded-pill ms-1"><?php $count = mysqli_num_rows(mysqli_query($db, "select * from job_post where deadline < '" . date('Y-m-d') . "'order by id desc"));
                                        echo number_format($count); ?></span></a>
                                </div>
                            </div>
                            <!-- End Collapse -->
                            ...
                            <div class="nav-item">
                                <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesUserProfileMenu"
                                    ...
                                    <span class="nav-link-title">Job Seekers <span
                                            class="badge bg-primary rounded-pill ms-1"><?php $count = mysqli_num_rows(mysqli_query($db, "select * from jobseeker_signup "));
                                ...
                                <div id="navbarVerticalMenuPagesUserProfileMenu" class="nav-collapse collapse "
                                    data-bs-parent="#navbarVerticalMenuPagesMenu"> <a class="nav-link "
                                        ...
                                        Registered Users<span
                                            class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab('jobseeker_signup')) ?></span></a>
                                    <a class="nav-link " href="applicants?cat=<?php echo base64_encode('applied'); ?>">
                                        <i class="bi-people-fill nav-icon"></i>
                                        Applicants<span
                                            class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('jobs_applied', 'status', 'applied')) ?></span></a>
                                    <a class="nav-link " href="applicants?cat=<?php echo base64_encode('assessment'); ?>">
                                        <i class="bi-stopwatch-fill nav-icon"></i>
                                        Assesments<span
                                            class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('jobs_applied', 'status', 'assessment')); ?></span></a>
                                    <a class="nav-link "
                                        href="applicants?cat=<?php echo base64_encode('first level interview'); ?>">
                                        <i class="bi-bank2 nav-icon"></i>
                                        First Level Interview<span
                                            class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('jobs_applied', 'status', 'First Level Interview')) ?></span></a>
                                    <a class="nav-link "
                                        ...
                                        Second Level Interview<span
                                            class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('jobs_applied', 'status', 'Second Level Interview')) ?></span></a>
                                    <a class="nav-link " href="applicants?cat=<?php echo base64_encode('successful'); ?>">
                                        <i class="bi-hand-thumbs-up-fill nav-icon"></i>
                                        Successful<span
                                            class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('jobs_applied', 'status', 'Successful')) ?></span></a>
                                    <a class="nav-link " href="applicants?cat=<?php echo base64_encode('unsuccessful'); ?>">
                                        <i class="bi-hand-thumbs-down-fill nav-icon"></i>
                                        Unsuccessful<span
                                            class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('jobs_applied', 'status', 'Unsuccessful')) ?></span></a>
                                </div>
                            </div>
                            <!-- End Collapse -->
                        <?php } ?>
                            ...
                            <div class="nav-item">
                                <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesAccountMenu"
                                    ...
                                    <span class="nav-link-title">Onboarding<span
                                            class="badge bg-primary rounded-pill ms-1"><?php $count = mysqli_num_rows(mysqli_query($db, "select * from emp_staff_details where completed = 'Y' || completed = 'N' "));
                                            echo number_format($count); ?></span></span>
                                </a>
                                ...
                                <div id="navbarVerticalMenuPagesAccountMenu" class="nav-collapse collapse "
                                    ...
                                    <a class="nav-link " href="onboarding-user?cat=<?php echo base64_encode('N'); ?>">
                                        ...
                                        Pending<span
                                            class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('emp_staff_details', 'completed', 'N')) ?></span></a>
                                    <a class="nav-link " href="onboarding-user?cat=<?php echo base64_encode('Y'); ?>">
                                        <i class="bi-hand-thumbs-up-fill nav-icon"></i>
                                        Completed<span
                                            class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('emp_staff_details', 'completed', 'Y')) ?></span></a>
                                </div>
                            </div>
                            <!-- End Collapse -->
                        <?php } ?>
                                    ...
                                    <div id="navbarVerticalMenuPagesEcommerceMenu" class="nav-collapse collapse "
                                        ...
                                        <a class="nav-link "
                                            ...
                                            New Verification<span
                                                class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('emp_staff_details', 'completed', 'Pending Verification')) ?></span></a>
                                        <a class="nav-link "
                                            href="verification?cat=<?php echo base64_encode('Completed Verification'); ?>">
                                            <i class="bi-hand-thumbs-up-fill nav-icon"></i>
                                            Completed Verification<span
                                                class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('emp_staff_details', 'completed', 'Completed Verification')) ?></span></a>
                                    </div>
                                </div>
                                <!-- End Collapse -->
                        <?php }
                            ...
                            <div class="nav-item">
                                <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesProjectsMenu"
                                    ...
                                    <span class="nav-link-title">Deploy Candidates<span
                                            class="badge bg-primary rounded-pill ms-1"><?php $count = mysqli_num_rows(mysqli_query($db, "select * from emp_staff_details where completed = 'Pool'"));
                                            echo number_format($count); ?></span></span>
                                </a>
                                ...
                                <div id="navbarVerticalMenuPagesProjectsMenu" class="nav-collapse collapse "
                                    ...
                                    <a class="nav-link " href="pool?cat=<?php echo base64_encode('pool'); ?>">
                                        <i class="bi-person-fill nav-icon"></i>
                                        Pool<span
                                            class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('emp_staff_details', 'completed', 'pool')) ?></span></a>
                                    <a class="nav-link " href="client?cat=<?php echo base64_encode('client'); ?>">
                                        <i class=" bi-hand-thumbs-up-fill nav-icon"></i>
                                        Assign To Client<span
                                            class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('emp_staff_details', 'completed', 'client')) ?></span></a>
                                </div>
                            </div>
                            <!-- End Collapse -->
                        <?php } ?>
                            ...
                            <div class="nav-item">
                                <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesProjectsMenu11"
                                    ...
                                    <span class="nav-link-title">HRBP<span
                                            class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('emp_staff_details', 'completed', 'client')) ?>
                                        </span></span>
                                </a>
                                ...
                                <div id="navbarVerticalMenuPagesProjectsMenu11" class="nav-collapse collapse "
                                    ...
                                    <a class="nav-link " href="assignedMessage">
                                        ...
                                        Offer Letter Approvals<span
                                            class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab('approve_message')); ?></span></a>


                                    <a class="nav-link " href="hrbp?cat=<?php echo base64_encode('staff'); ?>">
                                        <i class=" bi-hand-thumbs-up-fill nav-icon"></i>
                                        Staff List<span
                                            class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('emp_staff_details', 'completed', 'staff')) ?></span></a>
                                </div>
                            </div>
                            <!-- End Collapse -->
                        <?php } ?>
                                ...
                                <div id="navbarVerticalMenuAuthentication" class="nav-collapse collapse "
                                    ...
                                    <div id="navbarVerticalMenuAuthenticationMenu">
                                        ...
                                        <a class="nav-link " href="ongoing-appraisal">
                                            ...
                                            $count = mysqli_num_rows(mysqli_query($db, "select * from emp_appraisald_self where status != 'Completed' "));
                                            echo number_format($count);
                                            ?></span></a>
                                    </div>
                                </div>
                                        ...
                                        <div id="navbarVerticalMenuAuthentication1Menu">
                                            <a class="nav-link" href="assessment-category">
                                                ...
                                                Assessment Type<span
                                                    class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab('assessment_category')); ?></span></a>
                                            ...
                                            <a class="nav-link " href="view-questions">
                                                ...
                                                View Question<span
                                                    class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab('questions')) ?></span></a>
                                            ...
                                            <a class="nav-link " href="view-candidate">
                                                <i class="bi-eye-fill  nav-icon"></i>
                                                View Candidate<span
                                                    class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab('participant')); ?></span></a>
                                            <a class="nav-link " href="view-score">
                                                <i class="bi-eye-fill nav-icon"></i>
                                                View Scores<span
                                                    class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('exam_result', 'archieved', 'NULL')); ?></span></a>
                                            <a class="nav-link " href="archieve">
                                                <i class="bi-archive-fill nav-icon"></i>
                                                Archieved<span
                                                    class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab_val('exam_result', 'archieved', 'yes')); ?></span></a>
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
                            ...
                            <div class="nav-item">
                                <a class="nav-link dropdown-toggle  collapsed" href="#" role="button"
                                    ...
                                    <span class="nav-link-title">Clients<span
                                            class="badge bg-primary rounded-pill ms-1"><?php echo number_format(count_tab('clients')); ?></span></span>
                                </a>
                                ...
                                <div id="navbarVerticalMenuAuthentication3" class="nav-collapse collapse "
                                    ...
                                    <div id="navbarVerticalMenuAuthentication3Menu">
                                        <a class="nav-link " href="add-industry">
                                            ...
                                            Industry</a>
                                        <a class="nav-link " href="sub-accounts">
                                            <i class=" bi-person-fill nav-icon"></i>
                                            Sub accounts
                                        </a>
