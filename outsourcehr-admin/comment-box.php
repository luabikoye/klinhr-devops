...
<head>
    ...
    <!-- Title -->
    <title>View Applicants | KlinHR</title>
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
    ...
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
            <!-- Step Form -->
            <form class="js-step-form py-md-5" action="proc-comment" method="post" enctype="multipart/form-data" data-hs-step-form-options='{
                ...
                <div class="row justify-content-lg-center">
                    ...
                    "targetSelector": "#addUserStepProfile"
                                    ...
                                    <div class="step-content">
                                        <h3 class="">Comment :</h3>
                                        <p class="" style="color: #000;">Enter the Appropriate comment for returning candidate to the available pool.</p>
                                    </div>
                                </a>
                            </li>
                            ...
                            <div id="addUserStepProfile" class="card card-lg active">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <label for="locationLabel" class="col-sm-3 col-form-label form-label">Comment</label>

                                        <div class="col-sm-9">
                                            <!-- Select -->
                                            <div class="tom-select-custom mb-4">
                                                <input type="text" class="form-control" name="comment" id="comment" placeholder="" aria-label="" required value="<?php echo $comment; ?>">
                                    ...
                                    <div class="card-footer d-flex justify-content-end align-items-center">
                                        <!-- <a href="javascript:history.back()"><button type="button" name="goback" class="btn btn-primary">Go back</button></a> -->
