...
$query_offer = "Update emp_staff_details SET completed= 'staff', staff = 'yes', status = 'active' WHERE email_address='$email'";
...
if ($result_offer) {
    ...
    $body = "Dear HRBP, <br><br>
            A staff just accepted their offer letter.<br>
            Details below:<br>
            Name: " . $row_update['firstname'] . " <br>
