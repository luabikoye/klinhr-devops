...
if ($_SESSION['privilege_user'] == 'administrator') {
    $query = "SELECT * FROM emp_resumption_form where leave_type = 'Leave Resumption' order by id desc";
} elseif ($_SESSION['privilege_user'] == 'ALL') {
    $query = "SELECT * FROM emp_resumption_form where leave_type = 'Leave Resumption' order by id desc";
} else {
    $query = "SELECT * FROM emp_resumption_form where access_type like '%" . get_priviledge($_SESSION['privilege_user']) . "%' and leave_type = 'Leave Resumption' order by id desc";
}
...
<head>
    ...
    <!-- Title -->
    <title>Leave Resumption | KlinHR</title>
            ...
            <a class="btn btn-primary" href="javascript:;" data-bs-toggle="modal" data-bs-target="#newProjectModal">
              <i class="bi-plus me-1"></i> New project
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        Leave Resumption <span class="badge bg-soft-dark text-dark ms-1"><?php echo number_format($num) ?></span>
                    </li>
                    <!-- <li class="nav-item">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo substr($row['leave_type'], 0, 10); ?>...<a href="javascript:;" data-bs-toggle="modal" data-bs-target="#newProjectModal<?php echo ($row['id']); ?>">more</a>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="newProjectModalLabel"><?php echo get_names($row['staff_id']); ?>(<?= $row['staff_id']; ?>)</h5>
                                                            ...
                                                            <div id="createProjectStepFormContent">
                                                                <div id="createProjectStepDetails" class="active">
                                                                        ...
                                                                        <div class="row align-items-center">
                                                                            <div class="col-12 col-md-6 mb-3">
                                                                                ...
                                                                                <div class="input-group input-group-merge">
                                                                                    <input class="form-control" id="clientNewProjectLabel" readonly value="<?php echo stripslashes($row['email']); ?>" aria-label="Add creater name">
                                                                                </div>
                                                                            </div>
                                                                            <!-- End Col -->
                                                                            ...
                                                                            <div class="col-12 col-md-6 mb-3">
                                                                                <label for="clientNewProjectLabel" class="form-label">Manager</label>
                                                                                <div class="input-group input-group-merge">
                                                                                    <input class="form-control" id="clientNewProjectLabel" value="<?php echo stripslashes($row['manager']); ?>" readonly aria-label="Add creater name">
                                                                                </div>
                                                                            </div>
                                                                            <!-- End Col -->
                                                                        </div>
                                                                    ...
                                                                    <div class="mb-4">
                                                                        ...
                                                                        <div class="row align-items-center">
                                                                            <div class="col-12 col-md-6 mb-3">
                                                                                <label for="clientNewProjectLabel" class="form-label">Manager Email</label>
                                                                                <div class="input-group input-group-merge">
                                                                                    <input class="form-control" id="clientNewProjectLabel" readonly value="<?php echo stripslashes($row['manager_email']); ?>" aria-label="Add creater name">
                                                                                </div>
                                                                            </div>
                                                                            <!-- End Col -->
                                                                            ...
                                                                            <div class="col-12 col-md-6 mb-3">
                                                                                <label for="clientNewProjectLabel" class="form-label">Type of Leave</label>
                                                                                <div class="input-group input-group-merge">
                                                                                    <input class="form-control" id="clientNewProjectLabel" value="<?php echo stripslashes($row['leave_type']); ?>" readonly aria-label="Add creater name">
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            <!-- Form -->
                                                                            <div class="mb-4">
                                                                                <label for="projectDeadlineNewProjectLabel" class="form-label text-danger">Date Applied</label>

                                                                                <div id="projectDeadlineNewProject" class="input-group input-group-merge">
                                                                                    <input type="date" class="form-control" id="projectDeadlineNewProjectLabel" value="<?php echo stripslashes($row['letter_date']); ?>" readonly>
                                                                                </div>
                                                                            </div>
                                                                            <!-- End Form -->
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <!-- Form -->
                                                                            <div class="mb-4">
                                                                                <label for="ownerNewProjectLabel" class="form-label text-danger">Start Date</label>

                                                                                <!-- Select -->
                                                                                <div id="projectDeadlineNewProject" class="input-group input-group-merge">
                                                                                    <input type="date" class="form-control" id="projectDeadlineNewProjectLabel" value="<?php if ($row['start_date'] != '0000-00-00') {
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            <!-- Form -->
                                                                            <div class="mb-4">
                                                                                <label for="projectDeadlineNewProjectLabel" class="form-label text-danger">End Date</label>

                                                                                <div id="projectDeadlineNewProject" class="input-group input-group-merge">
                                                                                    <input type="date" class="form-control" id="projectDeadlineNewProjectLabel" value="<?php echo stripslashes($row['end_date']); ?>" readonly>
                                                                                </div>
                                                                            </div>
                                                                            <!-- End Form -->
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <!-- Form -->
                                                                            <div class="mb-4">
                                                                                <label for="ownerNewProjectLabel" class="form-label text-danger">Resupmtion Date</label>

                                                                                <!-- Select -->
                                                                                <div id="projectDeadlineNewProject" class="input-group input-group-merge">
                                                                                    <input type="date" class="form-control" id="projectDeadlineNewProjectLabel" value="<?php echo stripslashes($row['resumption_date']);  ?>" readonly>
                                                                                </div>
                                                                                <!-- End Select -->
                                                                            </div>
                                                                            <!-- End Form -->
                                                                    ...
                                                                    <div class="d-flex align-items-center mt-5">
                                                                        <div class="ms-auto">
                                                                            <a download href="../staffportal/<?php echo $row['image_path']; ?>" class="btn btn-primary" data-hs-step-form-next-options='{
                                                                                "targetSelector": "#createProjectStepTerms"
                                                                                }'>
                                                                                Download Resumption From
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                    <!-- End Footer -->
