...
$query = "insert into emp_news set title = '$title', filename = '$path', content = '$content', date = '$date_posted', access_type = '$access_type', summary = '$content' ";
...
if ($result) {
    ...
    activity_log($_SESSION['Klin_admin_email'], "Added a new news with title: $title");

    $success = "News has been successfully added";
    include('add-news.php');
    exit;
} else {
