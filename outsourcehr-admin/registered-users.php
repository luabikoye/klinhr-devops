...
<head>
  ...
  <!-- Title -->
  <title>Registered User | KlinHR</title>
    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        ...
        <ul class="nav nav-tabs page-header-tabs">
          <li class="nav-item">
            Registered Users <span class="badge bg-soft-dark text-dark ms-1"><?php echo number_format(count_tab('jobseeker_signup')) ?></span>
          </li>
          <!-- <li class="nav-item">
        ...
        <div class="card-body">
          <div class="d-flex align-items-md-center">
            <div class="flex-shrink-0">
              <span class="display-3 text-dark"><?php echo number_format(count_tab('jobseeker_signup')) ?></span>
            </div>

            <div class="flex-grow-1 ms-3">
              <div class="row mx-md-n3">
                <div class="col-md px-md-4">
                  <span class="d-block">Total Registered Users</span>
                ...
                <div class="col-md-9 col-lg-10 column-md-divider px-md-4">
                  <div class="row justify-content-start mb-2">
                    <div class="col-auto">
                      <span class="legend-indicator bg-<?php echo progress_color('active'); ?>"></span>
                      Active (<?php echo count_tab_val('jobseeker_signup', 'status', 'active', $_SESSION['account_token']) ?>)
                    </div>
                    <!-- End Col -->

                    <div class="col-auto">
                      <span class="legend-indicator bg-<?php echo progress_color('updated') ?>"></span>
                  ...
                  <div class="progress rounded-pill">                    
                      <div class="progress-bar bg-<?php echo progress_color('active') ?>" role="progressbar" style="width: <?php echo sub_seeker_percent() ?>%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="<?php echo number_format(count_tab('jobseeker_signup')) ?>"></div>
                      <div class="progress-bar bg-<?php echo progress_color('updated') ?>" role="progressbar" style="width: <?php echo sub_not_seeker_percent() ?>%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="<?php echo number_format(count_tab('jobseeker_signup')) ?>"></div>                    
                  </div>
                  <!-- End Progress -->
                </div>
                <!-- End Col -->
      ...
      <!-- Card -->
      <form action="export-registered" method="post" enctype="multipart/form-data">
        <div class="card">
          <!-- Header -->
              ...
              <div id="datatableCounterInfo" style="display: none;">
                <div class="d-flex align-items-center">
                  ...
                  <button type="submit" class="btn btn-outline-danger btn-sm">
                    <i class=" bi-file-earmark-fill"></i> Export
                  </button>
                </div>
              </div>
              <!-- End Datatable Info -->
