...
$query = "select * from cards where $account_token order by id desc";
...
<head>
    ...
    <!-- Title -->
    <title>Greeting Cards | KlinHR</title>
            ...
            <div class="page-header">
                <div class="row align-items-end">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        Greeting Cards <span class="badge bg-soft-dark text-dark ms-1"><?php echo number_format($num) ?></span>
                    </div>
                    <!-- End Col -->

                    <div class="col-sm-auto">
                        <a class="btn btn-primary" href="add-card">
                            <i class="bi-plus me-1"></i> Add Cards
                        </a>
                    </div>
                    <!-- End Col -->
                </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><img src="../uploads/Cards/<?php echo $row['image']; ?>" class="img-fluid" alt="Image template" style="height: 80px"></td>
                                    <?php
                                    if (privilege() == 'Super Admin') {
                                    ?>
                                        <td>
                                            <a data-toggle="tooltip" data-placement="top" class="btn btn-sm btn-outline-secondary" data-original-title="Delete" href="delete_record?id=<?php echo base64_encode($row['id']); ?>&tab=<?= base64_encode('cards') ?>&return=<?= base64_encode('cards') ?>" onclick="return confirm('Are you sure you want to delete this card?');"><i class="bi-trash" style="margin-left:0px;"></i></a>
                                        </td>
                                    <?php } ?>
                                </tr>
                            <?php } ?>
