...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
    ...
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
            <!-- Step Form -->
            <form class="js-step-form py-md-5" action="proc_message_template" method="post" enctype="multipart/form-data" data-hs-step-form-options='{
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="tom-select-custom mb-4">
                                                <input type="text" class="form-control" name="template_name" class="form-control" id="inputName" required value="<?php echo $template_name; ?>">
                                            </div>
                                        </div>
                                        <!-- End Form -->
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-9">
                                                <!-- Select -->
                                                <div class="tom-select-custom mb-4">
                                                    <input type="text" class="form-control" name="template_subject" placeholder="" required value="<?php echo $template_subject; ?>">
                                                </div>
                                                <!-- End Select -->
                                            </div>
                                        </div>
