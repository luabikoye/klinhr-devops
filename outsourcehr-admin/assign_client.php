...
if (($_GET['valid'])) {
    $valid = base64_decode($_GET['valid']);
} else {
    if ($_POST['id']) {
        $valid = $_POST['id'];
    }
...
$sql = ("select * from jobs_applied where id in ($valid)");
...
$candidate_ids = implode(',', $candidate_id);
...
<head>
    ...
    <!-- Title -->
    <title>Assign To Client | KlinHR</title>
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
    ...
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
            <!-- Step Form -->
            <form class="js-step-form py-md-5" action="move_candidate" method="post" enctype="multipart/form-data" data-hs-step-form-options='{
                ...
                <div class="row justify-content-lg-center">
                    ...
                    "targetSelector": "#addUserStepProfile"
                                    ...
                                    <div class="step-content">
                                        <h3 class="">Onboard Candidate To Client :</h3>
                                    </div>
                                </a>
                            </li>
                        ...
                        <div id="addUserStepFormContent">
                            ...
                            <div id="addUserStepProfile" class="card card-lg active">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Form -->
                                    <div class="row mb-4">
                                        <label for="locationLabel" class="col-sm-3 col-form-label form-label">Employee Name</label>

                                        <div class="col-sm-9">
                                            <!-- Select -->
                                            <div class="tom-select-custom mb-4">
                                                <input type="text" readonly class="form-control" name="candidate_name[]" id="firstNameLabel" placeholder="" aria-label="" required value="<?php echo $names; ?>">
                                            </div>
                                        </div>
                                        <!-- End Form -->
                                        ...
                                        <!-- Form -->
                                        <div class="row mb-4">
                                            <label for="locationLabel" class="col-sm-3 col-form-label form-label">Email</label>

                                            <div class="col-sm-9">
                                                <!-- Select -->
                                                <div class="tom-select-custom mb-4">
                                                    <input type="email" readonly class="form-control" name="email[]" id="firstNameLabel" placeholder="" aria-label="" required value="<?php echo $email; ?>">
                                                </div>
                                                <!-- End Select -->
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            ...
                                            "placeholder": "Select Client"
                                                    ...
                                                    <input type="hidden" name="candidate_id" value="<?php echo $candidate_ids; ?>">
                                                </div>
                                                <!-- End Select -->
                                            </div>
                                        </div>
