...
if ($_SESSION['account_token']) {    
    $query = "select * from assessment_category where account_token = '".$_SESSION['account_token']."'";
}else{
    $query = "select * from assessment_category";
}
...
<head>
    ...
    <!-- Title -->
    <title>Assessment Category | KlinHR</title>
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-end">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        Current Assessment Types <span class="badge bg-soft-dark text-dark ms-1"><?php echo number_format($num) ?></span>
                    </div>
                    <!-- End Col -->

                    <div class="col-sm-auto">
                        <a class="btn btn-primary" href="javascript:;" data-bs-toggle="modal" data-bs-target="#newProjectModal">
                            <i class="bi-plus me-1"></i> Add Assessment Category
                        </a>
                    </div>
                    <!-- End Col -->
                </div>
            ...
            <div class="card">
                ...
                <div class="table-responsive datatable-custom">
                    <?php if ($_GET['del'] == 'success') echo '<div class="alert alert-success">Assessment Type successfully deleted</div>'; ?>
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="table-column-ps-0">Assessment Type</th>
                                <?php
                                ...
                                <tr>
                                    ...
                                    ?>
                                        <td>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="newProjectModalLabel">Edit Assessment :
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            "isValidate": false
                                                            }' method="post" action="proc_edit_category" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="row align-items-center">
                                                                                <div class="col-12 col-md-7 mb-3">
                                                                                    <div class="input-group input-group-merge">
                                                                                        <input class="form-control" id="clientNewProjectLabel" placeholder="" name="cat_name" value="<?= $row['category_name']; ?>" aria-label="">
                                                                                        <input type="hidden" name="id" value="<?php echo $row['id'] ?>">
                                                                                        <input type="hidden" name="old_cat_name" value="<?php echo $row['category_name'] ?>">
                                                                                    </div>
                                                                                </div>
                                                                                <!-- End Col -->
                                                                            </div>
                                            ...
                                            <a data-toggle="tooltip" data-placement="top" class="btn btn-sm btn-outline-secondary" data-original-title="Delete" href="delete-record?id=<?php echo $row['id']; ?>&tab=assessment_category&return=assessment-category" onclick="return confirm('Are you sure you want to delete this assessment?');"><i class="bi-trash" style="margin-left:0px;"></i></a>
                                        </td>
                                    <?php } ?>
                                </tr>
                            <?php } ?>
    ...
    <div class="modal fade" id="newProjectModal" tabindex="-1" aria-labelledby="newProjectModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="newProjectModalLabel">Add Assessment</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <form class="js-step-form" data-hs-step-form-options='{
                                                            ...
                                                            "endSelector": "#createProjectFinishBtn",
                                                            "isValidate": false
                                                            }' method="post" action="proc_add_category" enctype="multipart/form-data">
                            ...
                            <div id="createProjectStepDetails" class="active">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12 col-md-7 mb-3">
                                            <div class="input-group input-group-merge">
                                                <input class="form-control" id="clientNewProjectLabel" placeholder="" name="cat_name" value="<?= $cat_name; ?>" aria-label="">
                                            </div>
                                        </div>
                                        <!-- End Col -->
                                    </div>
