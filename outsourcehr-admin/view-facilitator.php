...
<head>
    ...
    <!-- Title -->
    <title>View Facilitators | KlinHR</title>
            ...
            <div class="page-header">
                <div class="row align-items-center mb-3">
                    <div class="col-md mb-2 mb-md-0">
                        <h1 class="page-header-title">Facilitators <span class="badge bg-soft-dark text-dark ms-1"><?= $ns ?></span></h1>

                    </div>
                    <!-- End Col -->

                    <div class="col-md-auto">
                        <a class="btn btn-primary" href="add-facilitator">
                            <i class="bi-plus me-1"></i> Add Facilitator
                        </a>
                    </div>
                    <!-- End Col -->
                </div>
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="table-column-ps-0">Phone</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    ?>
                                        <td><a target="blank" title="edit skill" class="btn btn-sm btn-outline-secondary" href="add-facilitator?d=<?= base64_encode($row['id']) ?>"><i class="bi-pencil"></i></a>
                                        <?php } ?></td>
                                </tr>
                            <?php } ?>
