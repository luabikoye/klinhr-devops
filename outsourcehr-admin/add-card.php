...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
    ...
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
            <!-- Step Form -->
            <form class="js-step-form py-md-5" action="proc_add_card" method="post" enctype="multipart/form-data" data-hs-step-form-options='{
                        ...
                        <div id="addUserStepFormContent">
                            ...
                            <div id="addUserStepProfile" class="card card-lg active">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Form -->
                                    <div class="row mb-4">
                                        <label for="locationLabel" class="col-sm-3 col-form-label form-label">Card Name</label>
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="tom-select-custom mb-4">
                                                <select name="card" id="" class="form-control">
                                                    ...
                                                    <option>Birthday Cards</option>
                                                    <option>New Year Cards</option>
                                                    <option>Easter Cards</option>
                                                    <option>Eid al-Fitr Cards</option>
                                                    <option>Eid al-Adha Cards</option>
                                                </select>
                                            </div>
                                        </div>
                                        <!-- End Form -->
                                        ...
                                        <!-- Form -->
                                        <div class="row mb-4">
                                            <label for="locationLabel" class="col-sm-3 col-form-label form-label">Card Image</label>
