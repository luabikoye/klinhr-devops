...
if ($_GET['unique']) {
    ...
    activity_log($_SESSION['Klin_admin_user'], 'Responded to  ' . get_val('emp_staff_details', 'email_address', $email, 'firstname') . ' ' . get_val('emp_staff_details', 'email_address', $email, 'surname') . ' grievance ');
}
if ($_SESSION['privilege_user'] == 'administrator') {
    $query = "SELECT * FROM emp_complaint  order by id desc";
} elseif ($_SESSION['privilege_user'] == 'ALL') {
    $query = "SELECT * FROM emp_complaint order by id desc";
} else {
    $query = "select * from emp_complaint where access_type like '%" . get_priviledge($_SESSION['privilege_user']) . "%' order by id desc";
}
        ...
        <div class="content container-fluid">
            ...
            <div class="card">
                ...
                <div class="table-responsive datatable-custom">
                    ...
                    <?php
                    if ($_GET['msg'] == 'sent') echo '<div class="alert alert-success"> Email sent successfully </div>'; ?>
                    <table id="datatable"
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo substr($row['msg'], 0, 20); ?>...<a href="javascript:;"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div id="createProjectStepFormContent">
                                                        <div id="createProjectStepDetails" class="active">
                                                            <!-- Form -->
                                                            <div class="mb-4">
                                                                <label for="clientNewProjectLabel" class="form-label"
                                                                    style="font-weight: bold;">Message</label>

                                                                <div class="row align-items-center">
                                                                    <div class="col-12 col-md-12 mb-3 pt-3">
                                                                        <textarea
                                                                            style="border: none;"><?= $row['msg']; ?></textarea>
                                                                    </div>
                                                                    <!-- End Col -->
                                                                </div>
                                                                <!-- End Row -->
                                                            ...
                                                            <div class="d-flex align-items-center mt-5">
                                                                <div class="ms-auto">
                                                                    <a href="reply_staff?email=<?php echo base64_encode($row['email']); ?>&sub=RE:Grievance&return_url='<?php echo base64_encode('grievances'); ?>'"
                                ...
                                <td>
                                    ...
                                    <a onClick="return confirm('Are you sure you have treated this issue?');"
                                        href="status_btn?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('emp_complaint'); ?>&e=<?php echo base64_encode($row['email']); ?>&n=<?php echo base64_encode($row['name']); ?>&sub=<?php echo base64_encode($row['sub']); ?>&return_url=<?php echo base64_encode('grievances?msg=success'); ?>&status=<?php echo base64_encode('done'); ?>"><input
                                            type="button" class="btn btn-sm btn-outline-secondary"
                                            value="Mark as Done" /></a>

                                    <?php } else { ?>
                                    <a onClick="return confirm('Are you sure you want to revert this complaint?');"
                                        href="status_btn?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('emp_complaint'); ?>&return_url=<?php echo base64_encode('grievances?msg=revert'); ?>&status=<?php echo base64_encode('pending'); ?>"><input
                                            type="button" value="Mark as Undone"
