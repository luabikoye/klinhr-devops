...
if ($_SESSION['privilege_user'] == 'ALL') {
    $query = "SELECT id, firstname, surname, middlename, position_code, company_code, 1st_qualification_code, 2nd_qualification_code, 3rd_qualification_code, 1st_course_code, 2nd_course_code, 3rd_course_code, staff_id, email_address, date FROM emp_staff_details  where EmployeeID != '' and staff = 'yes' order by status asc, id desc limit 100";
} else {
    $query = "SELECT id, firstname, surname, middlename, position_code, company_code, 1st_qualification_code, 2nd_qualification_code, 3rd_qualification_code, 1st_course_code, 2nd_course_code, 3rd_course_code, staff_id, email_address,date FROM emp_staff_details where company_code like '%" . get_priviledge_2($_SESSION['privilege_user']) . "%' and staff = 'yes'order by status asc, id desc limit 100";
}
// }
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        Staff List <span class="badge bg-soft-dark text-dark ms-1"><?php echo number_format($num) ?></span>
                    </li>
                </ul>
                <!-- End Nav -->
            </div>
                    ...
                    <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                        ...
                        <div id="datatableCounterInfo" style="display: none;">
                            <div class="d-flex align-items-center">
                                ...
                                <a class="btn btn-outline-danger btn-sm" href="javascript:;" id="sendEmailInvite" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasKeyboardShortcuts" data-target="#emailInvite" aria-controls="offcanvasKeyboardShortcuts">
                                    <i class="bi-x"></i> Remove staff
                                </a>
                            </div>
                        </div>
                        <!-- End Datatable Info -->
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="row">
                                                <div class="col-sm mb-4">
                                                    <small class="text-cap text-body">Search By Role</small>
                                      ...
                                      "dropdownWidth": "10rem"
                                                ...
                                                <div class="col-sm mb-4">
                                                    <small class="text-cap text-body">Search By Client </small>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasKeyboardShortcuts" aria-labelledby="offcanvasKeyboardShortcutsLabel">
        <div class="offcanvas-header">
            <h4 id="offcanvasKeyboardShortcutsLabel" class="mb-0">Remove staff</h4>
    ...
    <?php if ($_GET['error'] == 1) { ?>
        <script type="text/javascript">
            $(function() {
                toastr.options.closeButton = true;
                toastr.options.positionClass = 'toast-bottom-right';
                toastr['success']('Staff not removed', );
            });
        </script>
    <?php } ?>
