...
<head>
    ...
    <!-- Title -->
    <title>Notofication Email | KlinHR</title>
            ...
            <div class="page-header">
                <div class="row align-items-center mb-3">
                    <div class="col-md mb-2 mb-md-0">
                        <h1 class="page-header-title">Current Email <span class="badge bg-soft-dark text-dark ms-2"><?php echo number_format(count_tab('notification_email')); ?></span></h1>
            ...
            <div class="card">
                ...
                <div class="table-responsive datatable-custom">
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <tbody>
                            <?php
                            $query = "select * from notification_email where $account_token";
                                ...
                                <tr>
                                    ...
                                    ?>
                                        <td>
                                            ...
                                            <a data-toggle="tooltip" data-placement="top" class="btn btn-sm btn-outline-secondary" data-original-title="Edit" title="Edit" href="javascript:;" data-bs-toggle="modal" data-bs-target="#newProjectModal<?= $row['id'] ?>"><i class="bi-pencil" style="margin-left:0px;"></i></a>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="newProjectModalLabel">Edit Notification Email</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            "isValidate": false
                                                            }' method="post" action="proc_edit_email" enctype="multipart/form-data">
                                                                                ...
                                                                                <div class="col-12 col-md-12 mb-3">
                                                                                    <div class="input-group input-group-merge">
                                                                                        <select name="privilege" class="form-control">
                                                                                            ...
                                                                                            ?>
                                                                                                <option selected value="<?php echo $row['privilege']; ?>"><?php echo $row['privilege']; ?></option>
                                                                                            <?php }
                                                                                            ?>
