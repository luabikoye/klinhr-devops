    ...
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <form action="proc-candidate" method="post" enctype="multipart/form-data">
                        <div class="d-grid gap-3 gap-lg-5">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        <label for="organizationLabel" class="col-sm-3 col-form-label form-label">Staff ID</label>

                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="staff_id" id="organizationLabel" placeholder="Client" aria-label="Your organization" value="">
                                        </div>
                                    </div>
                                    <!-- End Form -->
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" name="date_of_birth" id="departmentLabel" placeholder="" aria-label="Your department" value="<?= ($row['date_of_birth']) ?>">
                                        </div>
                                    </div>
                                    <!-- End Form -->
                            ...
                            <div id="other" class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="state_origin" class="js-select form-select" id="state">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="local_govt_of_origin_code" class="js-select form-select" id="govt">
                                                <option value="" disabled selected>Select Local Governmernt</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                    ...
                                    <div class="row mb-4">
                                        <label for="newEmailLabel" class="col-sm-3 col-form-label form-label">BVN</label>

                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="bvn" id="newEmailLabel" placeholder="" aria-label="Enter new email address" value="">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label for="newEmailLabel" class="col-sm-3 col-form-label form-label">NIN</label>

                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="nin" id="newEmailLabel" placeholder="" aria-label="Enter new email address" value="">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label for="newEmailLabel" class="col-sm-3 col-form-label form-label">Bank Name</label>

                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="payment_code" id="newEmailLabel" placeholder="" aria-label="Enter new email address" value="">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label for="newEmailLabel" class="col-sm-3 col-form-label form-label">Bank Account</label>

                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="bank_account_number" id="newEmailLabel" placeholder="" aria-label="Enter new email address" value="">
                                        </div>
                                    </div>
                                    <!-- End Form -->
                            ...
                            <div id="nysc" class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        <label for="accounttextLabel" class="col-sm-3 col-form-label form-label">Add Staff To:</label>

                                        <div class="col-sm-9">
                                            <select name="completed" id="" class="js-select form-select">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="submit" class="form-control btn btn-primary" value="Add Staff Details">
                                        </div>
                                    </div>
