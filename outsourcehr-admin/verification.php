...
validatePermission('Verification');
...
<head>
    ...
    <!-- Title -->
    <title>Verification | KlinHR</title>
            ...
            <div class="page-header">
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        ...
                        <?php if ($cat == 'Pending Verification') { ?>
                            Pending Verification List <span class="badge bg-soft-dark text-dark ms-1"><?php echo number_format(count_tab_val('emp_staff_details', 'completed', 'Pending Verification')) ?></span>
                        <?php } else { ?>

                            Completed Verification List <span class="badge bg-soft-dark text-dark ms-1"><?php echo number_format(count_tab_val('emp_staff_details', 'completed', 'Completed Verification')) ?></span>
            ...
            <form action="process-app?cat=<?php echo base64_encode($cat); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                <div class="row">
                                                    <div class="col-12 mb-4">
                                                        ...
                                                        <div class="tom-select-custom">
                                                            <select class="js-select form-select" name="stage">
                                                                <option value="Completed Verification">Completed Verification</option>
                                                                <?php if ($cat == 'Completed Verification') {
                                                                ...
                                                                ?>
                                                                    <option disabled>Move back to </option>
                                                                    <option value="completed_onboarding">Completed Onboarding</option>
                                                                <?php } else if ($cat == 'Completed Verification') {
                                                                ?>
                                                                    <option disabled>Move back to </option>
                                                ...
                                                <div class="d-grid">
                                                    <input type="submit" id="move" class="btn btn-primary" name="btn_move" value="Move" onclick="return confirm('Kindly view the applicants information before making a move. If you are sure of all the candidate\'s information, click OK ');">
                                                </div>
                    ...
                    <div class="table-responsive datatable-custom">
                        ...
                        ?>
                        <?php if ($_GET['del'] == 'success') echo '<div class="alert alert-success">Candidate successfully deleted</div>'; ?>

                        <?php if ($_GET['completed'] == 'verification') echo '<div class="alert alert-success">Candidate successfully moved to Completed verification</div>'; ?>
                        ...
                        <?php if ($_GET['pool'] == 'success') echo '<div class="alert alert-success">Candidate successfully moved to Pool</div>'; ?>
                        ...
                        <?php if ($_GET['pending'] == 'reversed') echo '<div class="alert alert-success">Candidate successfully reversed to Pending Verification</div>'; ?>

                        <?php if ($_GET['completed'] == 'reversed') echo '<div class="alert alert-success">Candidate successfully reversed to Completed Verification</div>'; ?>

                        <?php if ($_GET['pool'] == 'completed') echo '<div class="alert alert-success">Candidate successfully moved to Pool</div>'; ?>
                        <?php if ($_GET['onboarding'] == 'reversed') echo '<div class="alert alert-success">Candidate successfully reversed to Completed Onboarding</div>'; ?>
                   ...
                   "pagination": "datatablePagination"
                            ...
                            <tbody>
                                ...
                                if ($_GET['cat']) {
                                    ...
                                    $query = "select * from emp_staff_details where backlog = 'yes' order by id desc limit 0,500";
                                }
                                    ...
                                    <tr>
                                        <td class="table-column-pe-0">
                                            <div class="form-check">
                                                ...
                                                <input class="checkbox-tick" type="hidden" value="<?php echo $row['candidate_id']; ?>" name="candidate_id[]">
                                            ...
                                            <span class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h5 class="text-inherit mb-0">
                                                        <?php echo $row['firstname']; ?> <?php echo $row['surname']; ?></h5>
                                                    <span class="fs-5"><?php echo $row['email_address']; ?>
                                                </div>
                                            </span>
                                        </td>

                                        <td><?php echo substr($row['sex'], 0, 1); ?>
                                            <span class="badge bg-soft-dark text-dark ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="tasks completed today"><?php echo get_age($row['date_of_birth']); ?></span>
                                        </td>

                                        <td><?php echo $row['1st_qualification_code']; ?></td>
                                        <td><?php echo $row['company_code']; ?></td>
                                        <td><?php echo long_datetime($row['date_pending']); ?></i></td>
                                        <?php if ($cat == 'Completed Verification') {
                                        ?>
                                            <td><?php echo long_datetime($row['date_moved']); ?></td>
                                        <?php } ?>
                                        <td><?php echo VerificationStatus(($row['candidate_id'])); ?></td>
                                        <td>
                                            <a title="View Applicant" target="blank" class="btn btn-sm btn-outline-secondary" href="view-onboarding?id=<?php echo base64_encode($row['id']); ?>&uniqe=<?php echo base64_encode($row['email_address']); ?>"><i class="bi-eye"></i></a>

                                            <a title="Upload Evidence" class="btn btn-sm btn-outline-secondary" href="upload_evidence?candidate_id=<?php echo base64_encode($row['candidate_id']); ?>"><i class="bi-upload"></i></a>

                                            <?php if ($row['completed'] == 'Completed Verification') {
                                            ?>
                                                <a title="Move To Pool" class="btn btn-sm btn-outline-secondary" onclick="return confirm('Are you sure you want to move this candidate to pool?');" href="ProcessCandidate?pool_id=<?php echo base64_encode($row['candidate_id']); ?>"><i class="bi-arrows-move"></i></a>
                                            <?php } ?>
