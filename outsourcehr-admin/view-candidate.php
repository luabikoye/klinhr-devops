...
if ($_SESSION['account_token']) {
    if ($_GET['search']) {
        ...
        $query = "select * from participant where firstname like '%" . $search . "%' ||  lastname like '%" . $search . "%' ||  email like '%" . $search . "%' and account_token = '".$_SESSION['account_token']."' order by id desc";
    } else {
        $query = "select * from participant where account_token = '" . $_SESSION['account_token'] . "' order by id desc";
    }
}else{
    if ($_GET['search']) {
        $search = base64_decode($_GET['search']);
        $query = "select * from participant where firstname like '%" . $search . "%' ||  lastname like '%" . $search . "%' ||  email like '%" . $search . "%' order by id desc";
    } else {
...
<head>
    ...
    <!-- Title -->
    <title>View Candidates | KlinHR</title>
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        Registered Users <span
                            class="badge bg-soft-dark text-dark ms-1"><?php echo number_format(count_tab('jobseeker_signup')) ?></span>
                    </li>
                    <!-- <li class="nav-item">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-md-center">
                        <div class="flex-shrink-0">
                            <span
                                class="display-3 text-dark"><?php echo number_format(count_tab('participant')) ?></span>
                        </div>

                        <div class="flex-grow-1 ms-3">
                            <div class="row mx-md-n3">
                                <div class="col-md px-md-4">
                                    <span class="d-block">Total Participants</span>
                    ...
                    <i class="bi-graph-down"></i> -2 late in due
                                ...
                                <div class="col-md-9 col-lg-10 column-md-divider px-md-4">
                                    <div class="row justify-content-start mb-2">
                                        <div class="col-auto">
                                            <span
                                                class="legend-indicator bg-<?php echo progress_color('active'); ?>"></span>
                                            Active (<?php echo count_tab('participant') ?>)
                                        </div>
                                        <!-- End Col -->

                                        <!-- <div class="col-auto">
                                            <span
                                                class="legend-indicator bg-<?php echo progress_color('updated') ?>"></span>
                                            Inactive (<?php echo not_active() ?>)
                                        </div> -->
                                        <!-- End Col -->
                                    </div>
                                    <!-- End Row -->
                                    ...
                                    <div class="progress rounded-pill">
                                        <div class="progress-bar bg-<?php echo progress_color('active') ?>"
                                            role="progressbar" style="width: <?php echo seeker_percent() ?>%"
                                            aria-valuenow="40" aria-valuemin="0"
                                            aria-valuemax="<?php echo number_format(count_tab('jobseeker_signup')) ?>">
                                        </div>
                                        <div class="progress-bar bg-<?php echo progress_color('updated') ?>"
                                            role="progressbar" style="width: <?php echo not_seeker_percent() ?>%"
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <span class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="text-inherit mb-0">
                                                <?php echo check_flag($row['candidate_id']); ?>
                                ...
                                <td><?php
                                        if (strlen($row['email']) > 13) {
                                            echo substr($row['email'], 0, 13) . '...';
                                        } else {
                                            echo $row['email'];
                                        } ?></td>
                                ...
                                <td>
                                    <?php
                                        if (strlen($row['job_title']) > 13) {
                                            echo substr($row['job_title'], 0, 13) . '...';
                                        } else {
                                            echo $row['job_title'];
                                        } ?>
                                </td>
                                <td><?php echo $row['exam_code']; ?></td>
                                <td><?php echo $row['expire_date']; ?></i></td>
                            </tr>
                            <?php } ?>
