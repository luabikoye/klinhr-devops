...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
    ...
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
            <!-- Step Form -->
            <form class="js-step-form py-md-5" action="add-new-job" method="post" enctype="multipart/form-data"
                        ...
                        <div id="addUserStepFormContent">
                            ...
                            <div id="addUserStepProfile" class="card card-lg active">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                  if (check_yes_no('client_setting', 'job_img', 'yes') == 1) {
                  ?>
                                    <div class="row mb-4">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <label class="avatar avatar-xl avatar-circle avatar-uploader me-5"
                                                    ...
                                                    <input type="file" class="js-file-attach avatar-uploader-input"
                                                        name="job_image" id="avatarUploader"
                                    ...
                                    <!-- Form -->
                                    <div class="row mb-4">
                                        <label for="firstNameLabel" class="col-sm-3 col-form-label form-label">Job Title
                                        </label>

                                        <div class="col-sm-9">
                                            <div class="input-group input-group-sm-vertical">
                                                <input type="text" class="form-control" name="job_title"
                                                    value="<?= $job_title ?>" id="firstNameLabel" placeholder=""
                                                    aria-label="Clarice">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <label for="locationLabel"
                                            class="col-sm-3 col-form-label form-label">Industry</label>
                                        ...
                                        <div class="row mb-4">
                                            <label for="locationLabel"
                                                class="col-sm-3 col-form-label form-label">Minimum Qualification</label>
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <div class="tom-select-custom mb-4">
                                                    <select data-hs-tom-select-options='{
                                            "placeholder": "Select option"
                                        }' class="js-select form-select" id="locationLabel" name="qualification">
                                                        <option value="" selected>Select Qualification</option>
                                                        <option value="BACHELOR DEGREE">BACHELOR DEGREE</option>
                                                        <option value="BACHELOR DEGREE, MASTERS">BACHELOR DEGREE,
                                                            MASTERS</option>
                                                        <option value="OND, HND, BACHELOR">OND, HND, BACHELOR</option>
                                                        <option value="HND, BACHELOR">HND, BACHELOR</option>
                                                        <option value="MASTERS">MASTERS</option>
                                                        <option value="PHD">PHD</option>
                                                        <option value="HND">HND</option>
                                                        <option value="OND">OND</option>
                                                        <option value="NCE">NCE</option>
                                                        <option value="HIGH SCHOOL (S.S.C.E)">HIGH SCHOOL (S.S.C.E)
                                                        </option>
                                        ...
                                        <div class="row mb-4">
                                            <label for="locationLabel"
                                                class="col-sm-3 col-form-label form-label">Experience</label>

                                            <div class="col-sm-9">
                                                <!-- Select -->
                                                <div class="tom-select-custom mb-4">
                                                    <select name="experience" class="js-select form-select"
                                        ...
                                        <div class="row mb-4">
                                            <label for="locationLabel"
                                                class="col-sm-3 col-form-label form-label">Clients</label>
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <div class="tom-select-custom mb-4">
                                                    <select data-hs-tom-select-options='{
                                            "placeholder": "Select option"
                                        }' class="js-select form-select" id="locationLabel" name="client">
                                        ...
                                        <div class="row mb-4">
                                            <label for="locationLabel"
                                                class="col-sm-3 col-form-label form-label">Clients Logo</label>
                                                    ...
                                                    <label class="form-control" for="userAccountTypeRadio1">
                                                        <span class="form-check">
                                                            <input type="checkbox" class="form-check-input" value="yes"
                                                                name="show_client" id="userAccountTypeRadio1">
                                                            <span class="form-check-label">Display client logo on career
                                                                portal</span>
                                                        </span>
                                                    </label>
                                                </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <div class="tom-select-custom mb-4">
                                                    <select data-hs-tom-select-options='{
                                            "placeholder": "Select option"
                                        }' multiple class="js-select form-select" id="locationLabel" name="state">
                                        ...
                                        <!-- Form -->
                                        <div class="row mb-4">
                                            <label for="locationLabel" class="col-sm-3 col-form-label form-label">Job
                                                Type</label>
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <div class="tom-select-custom mb-4">
                                                    <select data-hs-tom-select-options='{
                                            "placeholder": "Select option"
                                        }' class="js-select form-select" id="locationLabel" name="job_type" required>
                                        ...
                                        <div class="row mb-4">
                                            <label for="locationLabel"
                                                class="col-sm-3 col-form-label form-label">Application Type</label>
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <div class="tom-select-custom mb-4">
                                                    <select data-hs-tom-select-options='{
                                            "placeholder": "Select option"
                                        }' class="js-select form-select" required id="locationLabel"
                                        ...
                                        <div class="row mb-4">
                                            <label for="organizationLabel"
                                                class="col-sm-3 col-form-label form-label">Salary</label>

                                            <div class="col-sm-9">
                                                <input type="text" required class="form-control" name="salary"
                                                    id="organizationLabel" placeholder="N300,000 monthly. Negotiable"
                                        ...
                                        <div class="row mb-4">
                                            <label for="departmentLabel"
                                                class="col-sm-3 col-form-label form-label">Deadline</label>

                                            <div class="col-sm-9">
                                                <input type="date" class="form-control" required name="deadline"
                                                    id="departmentLabel" placeholder="Deadline"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <!-- Quill -->
                                            <div class="quill-custom">
                                                <textarea name="qualification_requirement"
                                                    id="qualification_requirement" required></textarea>
                                                <script>
