...
if ($_SESSION['account_token']) {    
    $query = "select * from exam_result where archieved = 'yes' and account_token = '".$_SESSION['account_token']."' order by id desc";
}else{
    $query = "select * from exam_result where archieved = 'yes' order by id desc";
}
            ...
            <a class="btn btn-primary" href="javascript:;" data-bs-toggle="modal" data-bs-target="#newProjectModal">
              <i class="bi-plus me-1"></i> New project
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        Archieved Exam Results <span class="badge bg-soft-dark text-dark ms-1"><?php echo number_format($num) ?>
                    </li>
                    <!-- <li class="nav-item">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo ($row['start_time']); ?></i></td>
                                </tr>
