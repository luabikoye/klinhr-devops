      ...
      <div class="row">
        ...
        <div class="col-lg-6 d-flex justify-content-center align-items-center min-vh-lg-100">
          <div class="w-100 content-space-t-4 content-space-t-lg-2 content-space-b-1" style="max-width: 25rem;">
            <!-- Form -->
            <form method="post" action="proc-reset">
              ...
              <div class="mb-4">
                ...
                <?php if ($_GET['access'] == 'denied') echo '<div class="alert alert-danger" >Login with the right privilege</div>'; ?>
                <label class="form-label" for="resetPasswordSrEmail" tabindex="0">Your email</label>

                <input type="text" name="email" class="form-control form-control-lg" id="resetPasswordSrEmail" tabindex="1" placeholder="Enter your email address" aria-label="Enter your email address" value="<?php echo $email; ?>">
