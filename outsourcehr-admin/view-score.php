...
if ($_SESSION['account_token']) {    
    $query = "select * from exam_result where archieved IS NULL and account_token = '".$_SESSION['account_token']."' order by id desc";
}else{
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
    ...
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
            ...
            <!-- End Card -->
            <form action="process-exam?cat=<?php echo base64_encode($cat); ?>" method="post" enctype="multipart/form-data">
                <!-- Card -->
                <div class="card">
                    <!-- Header -->
                        ...
                        <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                            ...
                            <div id="datatableCounterInfo" style="display: none;">
                                <div class="d-flex align-items-center">
                                    ...
                                    <button class="btn btn-outline-primary btn-sm" type="submit" name="btn_export">
                                        <i class="bi-person"></i> Export Selected Candidate
                                    </button>
                                </div>
                            </div>
                            ...
                            <div id="datatableCounterInfo">
                                <div class="d-flex align-items-center">
                                    <a class="btn btn-outline-success btn-sm" href="export-results">
                                        <i class="bi-person"></i> Export All Candidates
                                    </a>
                                </div>
                            </div>
                            <!-- End Datatable Info -->
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form action="process-exam?cat=<?php echo base64_encode($cat); ?>" method="post">
                                                    ...
                                                    <div class="d-grid">
                                                        <input type="submit" id="move" class="btn btn-primary" name="btn_move" value="Move" onclick="return confirm('Moving candidate using this option does not send any notification to the candidates.\n\n If you intend to send notification to candidates, please use the email icon on the right. \n\n Do you want to continue?');">
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                ...
                                ?>
                                    <tr>
                                        <td class="table-column-pe-0">
                                            <!-- <div class="form-check"> -->
                                            <input class="form-check-input" type="checkbox" name="id[]" value="<?php echo $row['job_applied_id']; ?>" id="usersDataCheck2">
                                            <!-- </div> -->
                                        </td>
                                            ...
                                            <span class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h5 class="text-inherit mb-0">
                                                        <?php echo $row['fname']; ?> <?php echo $row['lname']; ?></h5>
                                        ...
                                        <td><?php echo $row['remark']; ?></i></td>
                                        <td><?php echo ($row['status']); ?></i></td>
                                        <td>
                                            <a target="blank" data-toggle="tooltip" data-placement="top" data-original-title="Delete Applicant" class="btn btn-sm btn-outline-secondary" onclick="return confirm('Are you sure you want to delete <?php echo $row['firstname']; ?>'s 'record?')" href="delete-record?id=<?php echo $row['id']; ?>&tab=exam_result&return=view-score"><i class=" bi-trash"></i></a>
    ...
    <!-- New Project Modal -->
    <div class="modal fade" id="emailInvite" tabindex="-1" aria-labelledby="newProjectModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
