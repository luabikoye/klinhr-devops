                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a style="margin-right: 15px; " data-toggle="tooltip" data-placement="top" title="View Document" class="btn btn-sm btn-outline-success" href="uploads_credentials/<?= ($credentials_row['credential']); ?>" target="_blank"><i class="bi-eye"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
