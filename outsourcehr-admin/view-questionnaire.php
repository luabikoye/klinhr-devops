...
$qry = "select * from questionnaire order by id desc";
...
<head>
    ...
    <!-- Title -->
    <title>View Questionnaire | KlinHR</title>
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        Client List <span class="badge bg-soft-dark text-dark ms-1"><?= $ns ?></span>
                    </li>
                    <!-- <li class="nav-item">
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="table-column-ps-0">Question Type</th>
                                <th class="table-column-ps-0">Question Count</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="table-column-ps-0">
                                        <?= get_val('qa', 'refID', $row['refID'], 'qaNum') ?>
                                    </td>
                                    <td class="table-column-ps-0">
                                        <?= $row['date'] ?>
                                    </td>
                                    ...
                                    ?>
                                        <td><a target="blank" title="edit skill" class="btn btn-sm btn-outline-secondary" href="questionaire?d=<?= base64_encode($row['refID']) ?>"><i class="bi-pencil"></i></a>
                                        <?php } ?></td>
                                </tr>
                            <?php } ?>
