...
<head>
    ...
    <!-- Title -->
    <title>View Skills | KlinHR</title>
            ...
            <div class="page-header">
                <div class="row align-items-center mb-3">
                    <div class="col-md mb-2 mb-md-0">
                        <h1 class="page-header-title">Skill List <span class="badge bg-soft-dark text-dark ms-1"><?= $ns ?></span></h1>

                    </div>
                    <!-- End Col -->

                    <div class="col-md-auto">
                        <a class="btn btn-primary" href="add-skill">
                            <i class="bi-plus me-1"></i> Add Skill
                        </a>
                    </div>
                    <!-- End Col -->
                </div>
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="table-column-ps-0">Name Of Skill</th>
                                <th>Courses</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            ...
                            for ($i = 1; $i <= $ns; $i++) {
                                ...
                                $qsPhase = mysqli_query($db, "select * from course where refID = '{$row['refID']}' order by id asc");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php for ($c = 0; $c < $nsPhase; $c++) {
                                            $rsC = mysqli_fetch_assoc($qsPhase);
                                            echo $rsC['course'];
                                        } ?>
                                    </td>
                                    <?php if (privilege() == 'Super Admin' &&  'Admin') {
                                    ?>
                                        <td><a target="blank" title="edit skill" class="btn btn-sm btn-outline-secondary" href="add-skill?d=<?= base64_encode($row['refID']) ?>"><i class="bi-pencil"></i></a>
                                        <?php } ?></td>
                                </tr>
                            <?php } ?>
