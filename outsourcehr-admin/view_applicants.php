...
// 	$query = "select * from jobs_applied where candidate_id = '$candidate_id'";
// }



$query = "select * from jobs_applied where id = '$id'";
          ...
          <div class="text-center mb-5">
            ...
            <ul class="list-inline list-px-2">
              ...
              <li class="list-inline-item">
                ...
                Applied <?php echo long_date($row['date_applied']); ?>
              </li>
            </ul>
              ...
              <div class="card mb-3 mb-lg-5">
                ...
                <div class="card-body">
                  <ul class="list-unstyled list-py-2 text-dark mb-0">
                    <li class="pb-0"><span class="card-subtitle">Qualification</span></li>
                    <li><i class="bi-person dropdown-item-icon"></i> <?php echo $row['qualification']; ?></li>

                    <li class="pt-4 pb-0"><span class="card-subtitle">Contacts</span></li>
                    <li><i class="bi-at dropdown-item-icon"></i> <?php echo $row['email']; ?></li>
                    <li><i class="bi-phone dropdown-item-icon"></i> <?php echo get_val('jobseeker', 'candidate_id', $row['candidate_id'], 'phone'); ?></li>

                    <li class="pt-4 pb-0"><span class="card-subtitle">Status</span></li>
                    <li class="fs-6 text-body"><i class="bi-graph-up dropdown-item-icon"></i> <?php echo $row['status']; ?></li>

                    <li class="pt-4 pb-0"><span class="card-subtitle">Age</span></li>
                    <li class="fs-6 text-body"><i class="bi-person dropdown-item-icon"></i> <?php echo $row['age']; ?> years old</li>

                    <li class="pt-4 pb-0"><span class="card-subtitle">Current / Expected Salary</span></li>
                    <li class="fs-6 text-body"><i class="bi-credit-card dropdown-item-icon"></i> <?php echo $row['current_salary']; ?> / <?php echo $row['expected_salary']; ?></li>

                    <li class="pt-4 pb-0"><span class="card-subtitle">Benefit Enjoyed</span></li>
                    <li class="fs-6 text-body"><i class="bi-emoji-smile dropdown-item-icon"></i> <?php echo $row['benefit_enjoyed']; ?></li>

                    <li class="pt-4 pb-0"><span class="card-subtitle">Benefit Expected</span></li>
                    <li class="fs-6 text-body"><i class="bi-emoji-smile dropdown-item-icon"></i> <?php echo substr($row['benefit_expected'], 0, 100); ?></li>
                  </ul>
                </div>
                <!-- End Body -->
              </div>
              ...
              <div class="card card-centered mb-3 mb-lg-5">
                ...
                <div class="card-body card-body">
                  ...
                  if (!$row['cv']) {
                    ...
                    $query2 = "select * from credentials where candidate_id  = '" . get_val('credentials', 'candidate_id', $row['candidate_id'], 'candidate_id') . "' ";
                  ...
                  ?>
                      ...
                      <iframe src="/uploads/documents/<?php echo $row2['filepath']; ?>" width="100%" height="100" style="height: 700px;"></iframe>
                    <?php }
                  } else {
                    ?>
                    <iframe src="/uploads/documents/<?php echo $row['cv']; ?>" width="100%" height="100" style="height: 700px;"></iframe>
                  <?php }
                  ?>
                </div>
                <!-- End Body -->
