...
$query2 = "select * from application_history where candidate_id = '$id' order by id desc";
...
<head>
    ...
    <!-- Title -->
    <title>View Comments | KlinHR</title>
                        ...
                        <div id="addUserStepFormContent">
                            ...
                            <div id="addUserStepProfile" class="card card-lg active">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if ($_GET['msg'] == 'success') echo '<div class="alert alert-success">Message Sent</div>'; ?>

                                    <!-- Form -->
                                    <div class="row mb-4">
                                        <p for="locationLabel" class="col-sm-3 col-form-label form-label"><?php echo $row2['comment']; ?></p>
