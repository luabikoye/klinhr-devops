        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        Clients <span class="badge bg-soft-dark text-dark ms-1"><?php echo number_format(count_tab_val('emp_staff_details', 'completed', 'client')) ?></span>
                    </li>
                    <!-- <li class="nav-item">
                    ...
                    <div class="mb-2 mb-md-0">
                        <form>
                            ...
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <input id="tableSearch" type="search" class="form-control" placeholder="Search users" aria-label="Search users">
                            </div>
                            <!-- End Search -->
                        </form>
                    </div>
