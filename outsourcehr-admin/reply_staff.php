...
<head>
    ...
    <!-- Title -->
    <title>Reply Staff | KlinHR</title>
                ...
                <div class="col-lg-12 mb-3 mb-lg-0">
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-header">
                            <h4 class="card-header-title">Send mail to staff </h4>
                        </div>
                        <!-- End Header -->
                        ...
                        <div class="card-body">
                            ...
                            <!-- Form -->
                            <form form data-toggle="validator" method="post" action="process-app" enctype="multipart/form-data">
                                <div class="mb-4">
                                    <label for="productNameLabel" class="form-label">Email </label>

                                    <input type="text" class="form-control" name="email" id="productNameLabel" placeholder="" value="<?= $email ?>" readonly required>
                                </div>
                                <!-- End Form -->
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <!-- Form -->
                                        <div class="mb-4">
                                            <label for="SKULabel" class="form-label">Subject</label>

                                            <input type="text" class="form-control" name="subject" id="SKULabel" placeholder="" value="<?= $sub ?>">
                                            <input type="hidden" name="id" value="<?php echo $id; ?>">
                                            <input type="hidden" name="return_url" value="<?php echo base64_decode($_GET['return_url']); ?>">
                                        </div>
                                        <!-- End Form -->
                                    </div>
                                    <!-- End Col -->
                                ...
                                <!-- End Quill -->
                                <input type="submit" value="Send Message" name="btn_send_email" class="btn btn-primary mt-3">
                            </form>
                        </div>
                        <!-- Body -->
                    </div>
